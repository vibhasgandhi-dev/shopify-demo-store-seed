...
def gql(q,v=None):
    ...
    return r.get('data',{})
U=lambda i,w=2000:f"https://images.unsplash.com/photo-{i}?w={w}&q=80&fm=jpg&fit=max"
V="Ember & Bean"
...
P=[
 ...
 dict(h="cold-brew-pitcher",t="Cold Brew Pitcher, 1.2 L",type="Brewer",tags=["brewers","cold-brew"],price=36,cmp=None,sku="EB-CB-12",imgs=["1622322816396-4363b777eee7","1625126590447-cb769384e1f0"],
 ...
 dict(h="hand-burr-grinder",t="Hand Burr Grinder",type="Grinder",tags=["espresso","grinder","travel"],price=69,cmp=None,sku="EB-HG-01",imgs=["1629248990514-c350da4e7bc9","1615327072330-6c8f4c063ece"],
 ...
 dict(h="milk-frother",t="Handheld Milk Frother",type="Accessory",tags=["accessories","milk"],price=29,cmp=None,sku="EB-FRO-01",imgs=["1597431007453-432af724fc88"],
 ...
 dict(h="brew-scale-with-timer",t="Brew Scale with Timer",type="Accessory",tags=["accessories","scale"],price=59,cmp=None,sku="EB-SCL-01",imgs=["1519978556112-ef795ceec8a5","1712664436140-3bb6b9b4d576"],
